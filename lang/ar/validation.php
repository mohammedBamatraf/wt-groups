...
return [
    ...
    'attributes' => [
        ...
        'year' => 'السنة',
        'first_phone_number' => 'رقم الهاتف الاول',
        'city_id' => 'المدينة',
        'second_phone_number' => 'رقم الهاتف التاني',
        'client_type' => 'نوع المستخدم',
        'back_image' => 'الصورة الخلفية',
        'front_image' => 'الصورة الامامية',
        'to_city_id' => 'وجهة الوصول',
        'from_city_id' => 'وجهة الذهاب',
        'vehicle_id' => 'المركبة',
        'available_seats' => 'المقاعد المتاحة',
        'trip_time' => 'وقت الرحلة',
        'plate_number' => 'رقم اللوحة',
        'brand_model_id' => 'السيارة',
        'year' => 'تاريخ الاصدار',
        'car_pictures' => 'صورة السيارة',
        'filter.starts_before' => 'من هذا التاريخ',
        'filter.starts_after' => 'الى هذا التاريخ',
        'filter.date' => 'التاريخ',
        'filter.from_city' => 'من مدينة',
        'filter.to_city' => 'الى مدينة',
        'adult' => 'البالغين',
        'child' => 'الاطفال',
        'passengers' => 'الركاب',
